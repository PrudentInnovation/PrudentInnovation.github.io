...
function sendEmail(encrypted) {
    var email="hello@prudentinnovation.org";
...
function showEncrypted(encrypted) {
    ...
    $('html, body').stop().animate({
        scrollTop: $('#encrypted').offset().top - 150
    }, 1500, 'easeInOutExpo');
}
...
function makeSubHeader(text) {
    // Header
    var parent = document.getElementById('note_info');
    parent.innerHTML = "Paste the following text into your email.";
}
